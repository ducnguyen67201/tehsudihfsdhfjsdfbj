...
## Corpus Check
- 555 files · ~294,895 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1615 nodes · 1932 edges · 53 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 443 edges (avg confidence: 0.8)
...
Cohesion: 0.03
Nodes (50): buildRoleExecutionBatches(), extractApiKeyPrefix(), generateWorkspaceApiKeyMaterial(), hashApiKeySecret(), verifyApiKeySecret(), createTRPCContext(), resolveApiKeyAuth(), resolveWorkspaceContext() (+42 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (58): buildTeamTurnUserMessage(), buildToolTraceMessages(), resolveProviderConfig(), createAgentForRole(), extractToolCalls(), formatDialogueMessages(), logLocalAgentDebug(), logToolUsage() (+50 more)
...
Cohesion: 0.06
Nodes (38): buildAuthorizationUrl(), autoJoinUserFromVerifiedGoogleProfile(), buildRedirectUri(), determineOutcome(), handleGoogleOAuthCallback(), handleGoogleOAuthStart(), redirectToLogin(), resolveWorkspaceAfterLogin() (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (37): isRoleTarget(), canRouteTo(), buildOpenQuestionRow(), claimNextQueuedInbox(), getRunProgress(), getRunProgressSnapshot(), initializeRunState(), isHumanResolutionMessage() (+29 more)
...
Cohesion: 0.07
Nodes (34): assign(), writeAuditEvent(), closeAsNoAction(), extractEventThreadTs(), extractSlackMessageTs(), loadConversationDeliveryContext(), loadReplyPayloadForCommand(), normalizeReplyPayload() (+26 more)
...
- **Thin community `Community 31`** (8 nodes): `prompt-format-benchmark-fixtures.test.ts`, `session-digest.ts`, `buildSessionDigestFixture()`, `parseAction()`, `parseConsoleEntry()`, `parseError()`, `parseNetworkFailure()`, `reconstructSessionDigest()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (7 nodes): `sidebar.tsx`, `cn()`, `handleKeyDown()`, `SidebarMenu()`, `SidebarMenuButton()`, `SidebarMenuItem()`, `useSidebar()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `GET()` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 22`, `Community 25`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `update()` connect `Community 0` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 14`, `Community 17`, `Community 20`, `Community 22`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `resolveApiKeyAuth()` connect `Community 1` to `Community 0`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Are the 47 inferred relationships involving `GET()` (e.g. with `main()` and `sendWithRetry()`) actually correct?**
